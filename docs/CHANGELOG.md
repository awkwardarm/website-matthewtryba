...
- Removed the "Enjoying These Tools?" section (tier list, general donate widget, and recurring-donation link); each tool's widget now reads "Donate to {tool}." with "Secure checkout by Stripe." on the next line.
